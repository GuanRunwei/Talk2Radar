...
data_root = 'data/talk2radar/radar_5frames/'
...
model = dict(
    ...
    middle_encoder=dict(
        in_channels=64, output_shape=[320,320], type='PointPillarsScatter'), # original 496,432, pcd range / voxel size
    text_backbone=dict(
        type='TextEncoder',
        pretrained_path="/home/guanrunwei/talk2radar/talk2sensors-main/mmdet3d/models/pretrained_bert/albert-base-v2",
    ),
    fusion_ops=dict(
        type='ThreeStageMHCA',
        text_dim=768,
        feature_dim_list=[64, 128, 256], 
    ),
    neck=dict(
...
test_evaluator = dict(
    type='KittiMetric',
    ann_file='data/talk2radar/radar_5frames/talk2radar_infos_val.pkl',
    metric='bbox',
    format_only=True,
