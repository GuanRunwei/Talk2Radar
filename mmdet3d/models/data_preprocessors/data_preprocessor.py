...
class Det3DDataPreprocessor(DetDataPreprocessor):
    ...
    def __init__(self,
        ...
        self.tokenizer = transformers.AlbertTokenizerFast.from_pretrained("/home/guanrunwei/talk2radar/talk2sensors-main/mmdet3d/models/pretrained_bert/albert-base-v2")
        print("load albert tokenizer successfully!")
        if voxel:
    ...
    def simple_process(self, data: dict, training: bool = False) -> dict:
        ...
        inputs, prompts, data_samples = data['inputs'], data['prompt'], data['data_samples']
        batch_inputs = dict()

        prompt_query = self.tokenizer(prompts['text_prompt'], truncation=True, padding='max_length', max_length=30,
                                      return_tensors="pt")
            
        batch_inputs['prompts'] = prompt_query
    ...
    def voxelize(self, points: List[Tensor],
        ...
        if self.voxel_type == 'hard':
            ...
            for i, res in enumerate(points): #test: ~982 points
