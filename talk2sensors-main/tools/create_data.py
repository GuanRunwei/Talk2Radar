...
def talk2radar_data_prep(root_path,
                    info_prefix,
                    version,
                    out_dir,
                    with_plane=False):
    ...
    info_trainval_path = osp.join(out_dir, f'{info_prefix}_infos_trainval.pkl')
    info_test_path = osp.join(out_dir, f'{info_prefix}_infos_test.pkl')
    update_pkl_infos('talk2radar', out_dir=out_dir, pkl_path=info_train_path)
    update_pkl_infos('talk2radar', out_dir=out_dir, pkl_path=info_val_path)
    update_pkl_infos('talk2radar', out_dir=out_dir, pkl_path=info_trainval_path)
    update_pkl_infos('talk2radar', out_dir=out_dir, pkl_path=info_test_path)
    create_groundtruth_database(
        'Talk2RadarDataset',
        root_path,
        info_prefix,
